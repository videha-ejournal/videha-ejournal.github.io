#!/usr/bin/env python3
"""Prepare non-quiz HTML/HTM from videha-ejournal.github.io for federated Search All Videha."""
...
EXCLUDE={'.git','.github','pagefind','pagefind-quiz','pagefind-videha-search','_pagefind_videha_build','node_modules','data'}
...
print(f'Prepared {count} non-quiz root-site HTML/HTM pages')
